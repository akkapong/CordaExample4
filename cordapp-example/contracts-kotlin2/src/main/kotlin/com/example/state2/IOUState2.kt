...
import com.example.schema2.IOUSchemaV1
...
/**
 * The state2 object recording IOU agreements between two parties.
 *
 * A state2 must implement [ContractState] or one of its descendants.
 *
...
data class IOUState2(val value: Int,
                     val lender: Party,
                     val borrower: Party,
